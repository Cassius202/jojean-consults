...
const Hero = () => {
  ...
  return (
    <section id='home' className="w-full pt-25 max-lg:pt-15 px-3 sm:px-5 md:px-10 lg:px-20 relative pb-15 dark:bg-linear-to-b from-neutral-950 via-neutral-950 to-gray-900/40 isolate transition-colors duration-300">
      <div className="flex flex-col lg:grid grid-cols-[55%_40%] gap-[5%]">
        <div className="flex flex-col items-start max-lg:items-center justify-center">
          ...
          <p className="font-medium max-sm:px-1 md-contrast text-lg tracking-wide max-lg:text-center max-lg:max-w-2xl">
         ...
         <div className="flex max-sm:flex-col gap-4 max-lg:mb-6 mt-7">
      ...
      <div className="absolute max-lg:hidden -z-10 -bottom-40 left-80 w-100 overflow-hidden rounded-xl shadow-2xl shadow-black/60 dark:shadow-slate-200/20">
